...
do
	...
	local unitGroups =
	{
		{ UnitId = 292, Level = 3, Count = 12 },
		{ UnitId = 300, Level = 3, Count = 10 },
		{ UnitId = 294, Level = 3, Count = 18 },
		{ UnitId = 293, Level = 3, Count = 7 },
